...
void System::Sign_in_as_admin() {
	...
	while (i >= 1)
	{
		...
		X:
			...
			{
				int choice;
				cout << "\t" << " \t" << "If you want the First Dose Press 1 Or Second Dose press 2 : "; cin >> choice;
				if (choice == 1)
				{
					Admins[name].First_Dose_List_View();
					break;
				}
				else
				{
					Admins[name].Second_Dose_List_View();
					break;
				}
