...
void User::Edit() {
	...
	if (number == 1) {
		int x;
		cout << "                press 1 for first , 2 for second , 3 for last and 4 for all name : "; cin >> x; cout << endl;
		if (x == 1) {
...
void User::users_operation()
{
	...
	cout << "                   3.Display data             4.Log Out        " << endl;
	cout << endl;
	string ans;
	...
	{
		cout << "Logging Out......." << "   " << "Thank you For Using Our System" << endl;
		System s;
		s.login_helper();
	}
...
void User::Display(int i) {
	...
	if (this->vaccine.dose1 == 1)
	{ 
		cout << " Took The First Dose And In the Second Dose Waiting List   "   << endl;
	}
	else if (this->vaccine.dose2 == 1)
	{
		cout << " Took Both Doses " << "\n";

	}

	else if (this->vaccine.vac == "0")
	{
		cout << " In the first Dose Waiting List" << "\n";
