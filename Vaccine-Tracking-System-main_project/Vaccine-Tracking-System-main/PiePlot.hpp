...
void PieChart()
{
	...
	if (pModule)
	{
		...
		if (pFunc && PyCallable_Check(pFunc))
		{
			...
			PyObject_CallFunction(pFunc, "I,I,s,s,s", Vaccine::ones_count, Vaccine::both_count, "One Dose", "Two Doses", "Percentage Of People Who took the First Dose And The Second One ");
			...
			PyObject_CallFunction(pFunc, "I,I,s,s,s", Vaccine::both_dose_Female, Vaccine::both_dose_male, "Female", "Male", "Percentage Of Females And Males Who Took the both doses");
